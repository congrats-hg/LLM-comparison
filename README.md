...
기준 문구 — KR: `이 문장은 테스트용 문장입니다.` (9~10토큰) · EN: `This sentence is for a test.` (7~8토큰). 입력 = 출력 동일 길이 가정. 토큰 수는 모델 토크나이저별 실측치(§1).

| 모델 | 한국어 문장 1,000회 | 영어 문장 1,000회 |
|---|---:|---:|
| GPT-5 nano | 6원 ($0.004) | 5원 ($0.003) |
| Gemini 2.5 Flash-Lite | 8원 ($0.005) | 6원 ($0.004) |
| **GPT-5.4 nano** (현 프로젝트) | **20원 ($0.013)** | **15원 ($0.010)** |
| Gemini 3.1 Flash-Lite | 26원 ($0.018) | 21원 ($0.014) |
| GPT-5 mini | 30원 ($0.020) | 24원 ($0.016) |
| Gemini 2.5 Flash | 42원 ($0.028) | 34원 ($0.022) |
| Gemini 3 Flash | 53원 ($0.035) | 42원 ($0.028) |
| GPT-5.4 mini | 71원 ($0.047) | 55원 ($0.037) |
| GPT-5 | 152원 ($0.101) | 118원 ($0.079) |
| Gemini 2.5 Pro | 169원 ($0.113) | 135원 ($0.090) |
| Gemini 3.1 Pro | 210원 ($0.140) | 168원 ($0.112) |
| GPT-5.4 | 236원 ($0.158) | 184원 ($0.123) |
| GPT-5.5 | 473원 ($0.315) | 368원 ($0.245) |

> 가격은 토큰당 동일하지만 토크나이저 효율 차이로 같은 문장이라도 한국어가 영어보다 토큰 수가 약 1.2~1.4배 많아 비용도 그만큼 상승. 자세한 단가는 아래 입력/출력 단가표 참조.
